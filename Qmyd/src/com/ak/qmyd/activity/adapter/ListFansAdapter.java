...
public class ListFansAdapter extends BaseAdapter {
	...
	public ListFansAdapter(Context context, List<Funs> mDate,
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_listview_fans, null);
			holder.imgViewHead = (CircleImageView) convertView
					.findViewById(R.id.imgViewFansHead);
			holder.txtViewNickName = (TextView) convertView
					.findViewById(R.id.txtViewFansNickName);
		...
		if (data.get(position).getState().equals("1")) {
			holder.txtViewStatus.setText("ÒÑ¹Ø×¢");
		} else {
			holder.txtViewStatus.setText("+¹Ø×¢");
		}
