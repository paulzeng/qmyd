...
import com.ak.qmyd.adapt.BookingFagmentAdapt2.ViewHold;
...
public class ConsumptionAdapt2 extends BaseAdapter {

	private  List<OrderDetail> mlist;
	 
	private Context context;

	public ConsumptionAdapt2(List<OrderDetail> mlist, Context context) {
		super();
		this.mlist = mlist;
