...
import com.ak.qmyd.adapt.FinishFragmentAdapt.ViewHold;
...
public class ExpiredFragmentAdapt extends BaseAdapter {
	...
	public ExpiredFragmentAdapt(List<MyOrderList> venuesOrderList,
			Context context) {
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		  ViewHold viewHold;
			...
			viewHold.button_cancel.setText(venuesOrderList.get(arg0).getOrderType());
			viewHold.button_cancel.setBackgroundDrawable(null);
			...
			viewHold.myListView.setAdapter(new ExpiredFragmentAdapt2(venuesOrderList.get(arg0).getOrderDetailList(),
					context));
